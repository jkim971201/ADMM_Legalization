  ...
  : grid_(grid)
{
  ...
  const double dieLx = getConfig()->getDieLxMicron();
  const double dieLy = getConfig()->getDieLyMicron();
  const double dieUx = getConfig()->getDieUxMicron();
  const double dieUy = getConfig()->getDieUyMicron();
