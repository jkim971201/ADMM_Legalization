...
class dbDefReader
{
  public:
    ...
    // Region 
    static int defRegionCbk(defrCallbackType_e c, defiRegion* rg, defiUserData ud);
    ...
    static int defGroupMemberCbk (defrCallbackType_e c, const char* member, defiUserData ud);
