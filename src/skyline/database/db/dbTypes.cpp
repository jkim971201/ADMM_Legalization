...
dbTypes::dbTypes()
{
  ...
  str2RegionType_["FENCE"] = RegionType::FENCE;
  str2RegionType_["GUIDE"] = RegionType::GUIDE;
...
RoutingType
dbTypes::getRoutingType(std::string_view str) const
{
...
LayerDirection
dbTypes::getLayerDirection(std::string_view str) const
{
...
MacroClass
dbTypes::getMacroClass(std::string_view str) const
{
...
SiteClass
dbTypes::getSiteClass(std::string_view str) const
{
...
PinDirection
dbTypes::getPinDirection(std::string_view str) const
{
...
PinUsage
dbTypes::getPinUsage(std::string_view str) const
{
...
PinShape
dbTypes::getPinShape(std::string_view str) const
{
...
Orient
dbTypes::getOrient(std::string_view str) const
{
...
Source
dbTypes::getSource(std::string_view str) const
{
...
NetUse
dbTypes::getNetUse(std::string_view str) const
{
...
WireShape
dbTypes::getWireShape(std::string_view str) const
{
...
RegionType
dbTypes::getRegionType(std::string_view str) const
{
  auto itr = str2RegionType_.find(str);
  
  if(itr == str2RegionType_.end())
  {
    std::cout << "Error - REGION TYPE " << str;
    std::cout << " is unknown (or not supported yet)..." << std::endl;
    exit(0);
  }
  else
