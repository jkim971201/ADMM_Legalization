...
class dbLefReader
{
  public:
    ...
    static int lefViaRuleCbk    (lefrCallbackType_e c, lefiViaRule* viaRule, lefiUserData ud);
    // Tech Lef
    ...
    static int lefPropCbk       (lefrCallbackType_e c, lefiProp*       prop, lefiUserData ud);
